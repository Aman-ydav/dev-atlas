...
import { uploadLimiter, readLimiter, writeLimiter, commentLimiter } from "./middlewares/rateLimiter.middleware.js";
...
app.use("/api/v1/learning-paths", readLimiter, learningPathRouter);
app.use("/api/v1/case-studies", readLimiter, caseStudyRouter);
...
app.use("/api/v1/comments", commentLimiter, commentRouter);
